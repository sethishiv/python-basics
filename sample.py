...
cat1 = Cat()
cat1.be_annoying '''
#so both dog and cat classes are inheriting both the classes method defined in their parent class
...
'''from utils import find_max #instead of importing the whole module we can import only a specific function from the module
